...
public class RestoreHeight {
    ...
    RestoreHeight() {
        blockheight.put("2019-04-24", 1000L);
        blockheight.put("2019-04-24", 1500L);
        blockheight.put("2019-04-27", 2000L);
        blockheight.put("2019-04-28", 3500L);
        blockheight.put("2019-04-29", 3689L);
        blockheight.put("2019-04-29", 4092L);
        blockheight.put("2019-05-01", 4700L);
        blockheight.put("2019-05-03", 6000L);
        blockheight.put("2019-05-04", 6902L);
        blockheight.put("2019-05-04", 7000L);
        blockheight.put("2019-05-04", 7542L);
        blockheight.put("2019-05-04", 7654L);
        blockheight.put("2019-05-05", 9321L);
        blockheight.put("2019-05-07", 10692L);
        blockheight.put("2019-05-09", 11679L);
        blockheight.put("2019-05-22", 20000L);
        blockheight.put("2019-06-23", 40000L);
    }
    ...
    public long getHeight(final Date date) {
        ...
        if (cal.get(Calendar.YEAR) < 2019)
            return 0;
        if ((cal.get(Calendar.YEAR) == 2019) && (cal.get(Calendar.MONTH) <= 3))
            // before May 2014
            return 0;
