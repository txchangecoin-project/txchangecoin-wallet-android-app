...
git clone https://github.com/txchangecoin-project/txchangecoin-android-lib.git /tmp/txchangecoin-android-lib
cd /tmp/txchangecoin-android-lib/external-libs/
